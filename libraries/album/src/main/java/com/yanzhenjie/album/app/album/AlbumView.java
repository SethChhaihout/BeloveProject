...
class AlbumView extends Contract.AlbumView implements View.OnClickListener {
    ...
    public AlbumView(final Activity activity, Contract.AlbumPresenter presenter) {
        ...
        this.btnDone = activity.findViewById(R.id.btnDone);
    ...
    public void setupViews(Widget widget, int column, boolean hasCamera, int choiceMode) {
        ...
        if (widget.getUiStyle() == Widget.STYLE_LIGHT) {
            ...
            //set navigation icon here
            Drawable navigationIcon = getDrawable(R.drawable.ic_back);
